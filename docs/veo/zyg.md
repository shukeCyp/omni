...
| `size` | string | 否 | 视频尺寸，格式 `widthxheight` |
| `input_reference[]` | repeatable | 否 | 参考图字段，字段名必须带 `[]`，支持重复提交 |
...
- 服务类：`app/services/veo/zyg.py`
- 注册器：`app/services/media_generation.py` 中的 `ZygVeoGenerator`
